...
--
-- Ho... SQLINES DEMO ***
-- SQLINES DEMO *** Mar 04, 2026 at 02:17 PM
...
--
-- SQLINES DEMO *** rce2024`
--

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** or table `addresses`
--
...
--
-- SQLINES DEMO *** or table `cart_items`
--

CREATE TABLE cart_items (
  id bigint CHECK (id > 0) NOT NULL,
  cart_id bigint CHECK (cart_id > 0) NOT NULL,
...
--
-- SQLINES DEMO *** or table `inventory_transactions`
--

CREATE TABLE inventory_transactions (
  id bigint CHECK (id > 0) NOT NULL,
  product_id bigint CHECK (product_id > 0) NOT NULL,
  type varchar(30) check (type in ('in','out')) NOT NULL,
...
--
-- SQLINES DEMO *** table `inventory_transactions`
--
...
CREATE TABLE messages (
  id bigint CHECK (id > 0) NOT NULL,
  sender_id bigint CHECK (sender_id > 0) NOT NULL,
  receiver_id bigint CHECK (receiver_id > 0) NOT NULL,
  sender_type varchar(30) check (sender_type in ('user','admin')) NOT NULL,
  receiver_type varchar(30) check (receiver_type in ('user','admin')) NOT NULL,
...
(1, 'Xu Hướng Máy Hút Mùi 2025', 'xu-huong-may-hut-mui-2025', 'Khám phá những xu hướng mới nhất trong thiết kế và công nghệ máy hút mùi cho căn bếp hiện đại năm 2025.', '<h2>Xu Hướng Thiết Kế 2025</h2>rn<p>Năm 2025 mang đến những xu hướng thiết kế m&aacute;y h&uacute;t m&ugrave;i ho&agrave;n to&agrave;n mới, tập trung v&agrave;o t&iacute;nh thẩm mỹ v&agrave; hiệu quả sử dụng.</p>rn<h3>1. Thiết Kế Tối Giản</h3>rn<p>Xu hướng thiết kế tối giản tiếp tục thống trị thị trường với những đường n&eacute;t sạch sẽ, m&agrave;u sắc trung t&iacute;nh v&agrave; kiểu d&aacute;ng hiện đại.</p>rn<h3>2. C&ocirc;ng Nghệ Th&ocirc;ng Minh</h3>rn<p>C&aacute;c d&ograve;ng m&aacute;y h&uacute;t m&ugrave;i mới được t&iacute;ch hợp c&ocirc;ng nghệ IoT, cho ph&eacute;p điều khiển từ xa qua smartphone v&agrave; tự động điều chỉnh tốc độ h&uacute;t.</p>rn<h3>3. Tiết Kiệm Năng Lượng</h3>rn<p>Với c&ocirc;ng nghệ inverter ti&ecirc;n tiến, m&aacute;y h&uacute;t m&ugrave;i 2025 tiết kiệm điện năng l&ecirc;n đến 40% so với c&aacute;c d&ograve;ng cũ.</p>rn<h3>4. Vật Liệu Cao Cấp</h3>rn<p>Sử dụng th&eacute;p kh&ocirc;ng gỉ 304, k&iacute;nh cường lực v&agrave; c&aacute;c vật liệu chống b&aacute;m d&iacute;nh gi&uacute;p dễ d&agrave;ng vệ sinh v&agrave; bảo tr&igrave;.</p>', 'news/news_20260122081731_ga56pj.jpg', 'xu-hướng', 'Admin', 1, 1, 160, '2025-08-28 22:31:56', '2026-01-22 01:17:31'),
(2, 'Cách Bảo Trì Máy Hút Mùi', 'cach-bao-tri-may-hut-mui', 'Hướng dẫn chi tiết cách vệ sinh và bảo trì máy hút mùi để đảm bảo hiệu suất tối ưu và tuổi thọ lâu dài.', '<h2>Hướng Dẫn Bảo Tr&igrave; M&aacute;y H&uacute;t M&ugrave;i</h2>rn<p>Việc bảo tr&igrave; định kỳ m&aacute;y h&uacute;t m&ugrave;i kh&ocirc;ng chỉ gi&uacute;p tăng tuổi thọ sản phẩm m&agrave; c&ograve;n đảm bảo hiệu suất hoạt động tối ưu.</p>rn<h3>1. Vệ Sinh Bộ Lọc</h3>rn<p><strong>Tần suất:</strong> Mỗi th&aacute;ng 1 lần</p>rn<ul>rn<li>Th&aacute;o bộ lọc khỏi m&aacute;y</li>rn<li>Ng&acirc;m trong nước ấm với x&agrave; ph&ograve;ng</li>rn<li>Chải nhẹ bằng b&agrave;n chải mềm</li>rn<li>Rửa sạch v&agrave; để kh&ocirc; ho&agrave;n to&agrave;n</li>rn</ul>rn<h3>2. Vệ Sinh Th&acirc;n M&aacute;y</h3>rn<p><strong>Tần suất:</strong> Mỗi tuần 1 lần</p>rn<ul>rn<li>D&ugrave;ng khăn ẩm lau bề mặt ngo&agrave;i</li>rn<li>Tr&aacute;nh sử dụng h&oacute;a chất mạnh</li>rn<li>Lau kh&ocirc; bằng khăn mềm</li>rn</ul>rn<h3>3. Kiểm Tra Định Kỳ</h3>rn<p><strong>Tần suất:</strong> Mỗi 6 th&aacute;ng</p>rn<ul>rn<li>Kiểm tra d&acirc;y điện v&agrave; ổ cắm</li>rn<li>L&agrave;m sạch quạt gi&oacute;</li>rn<li>Kiểm tra độ rung v&agrave; tiếng ồn</li>rn</ul>', 'news/news_20260122081811_nrsigi.png', 'hướng-dẫn', 'Admin', 1, 1, 93, '2025-08-28 22:31:56', '2026-01-22 01:18:11'),
(3, 'Khuyến Mãi Tết Nguyên Đán', 'khuyen-mai-tet-nguyen-dan', 'Chương trình khuyến mãi đặc biệt nhân dịp Tết Nguyên Đán với nhiều ưu đãi hấp dẫn cho khách hàng.', '<h2>Chương Tr&igrave;nh Khuyến M&atilde;i Tết 2025</h2>rn<p>Nh&acirc;n dịp Tết Nguy&ecirc;n Đ&aacute;n, KitchenHood Pro mang đến chương tr&igrave;nh khuyến m&atilde;i đặc biệt với nhiều ưu đ&atilde;i hấp dẫn.</p>rn<h3>🎉 Ưu Đ&atilde;i Đặc Biệt</h3>rn<ul>rn<li><strong>Giảm gi&aacute; 30%</strong> cho tất cả sản phẩm m&aacute;y h&uacute;t m&ugrave;i</li>rn<li><strong>Miễn ph&iacute; vận chuyển</strong> to&agrave;n quốc</li>rn<li><strong>Tặng k&egrave;m bộ lọc</strong> trị gi&aacute; 500.000 VNĐ</li>rn<li><strong>Bảo h&agrave;nh mở rộng</strong> l&ecirc;n 7 năm</li>rn</ul>rn<h3>📅 Thời Gian &Aacute;p Dụng</h3>rn<p><strong>Từ ng&agrave;y:</strong> 15/01/2025<br><strong>Đến ng&agrave;y:</strong> 15/02/2025</p>rn<h3>🎁 Qu&agrave; Tặng Đặc Biệt</h3>rn<p>Kh&aacute;ch h&agrave;ng mua từ 2 sản phẩm trở l&ecirc;n sẽ được tặng th&ecirc;m:</p>rn<ul>rn<li>Bộ dụng cụ vệ sinh chuy&ecirc;n dụng</li>rn<li>G&oacute;i bảo tr&igrave; miễn ph&iacute; 1 năm</li>rn<li>Hướng dẫn sử dụng chi tiết</li>rn</ul>rn<h3>📞 Li&ecirc;n Hệ Ngay</h3>rn<p>Để được tư vấn v&agrave; đặt h&agrave;ng, vui l&ograve;ng li&ecirc;n hệ:</p>rn<ul>rn<li><strong>Hotline:</strong> 1900 1234</li>rn<li><strong>Email:</strong> sales@kitchenhoodpro.com</li>rn<li><strong>Website:</strong> www.kitchenhoodpro.com</li>rn</ul>', 'news/wXcFS1SowXTYEHp6gP2AAycKDs8rePhkZPnkA2ol.png', 'khuyến-mãi', 'Admin', 1, 1, 239, '2025-08-28 22:31:56', '2025-09-23 22:47:02'),
(4, 'Công Nghệ Lọc Không Khí Mới', 'cong-nghe-loc-khong-khi-moi', 'Khám phá công nghệ lọc không khí tiên tiến mới nhất được tích hợp trong các dòng máy hút mùi cao cấp hiện nay.', '<h2>C&ocirc;ng Nghệ Lọc Kh&ocirc;ng Kh&iacute; Ti&ecirc;n Tiến</h2>rn<p>C&ocirc;ng nghệ lọc kh&ocirc;ng kh&iacute; trong m&aacute;y h&uacute;t m&ugrave;i đ&atilde; c&oacute; những bước tiến vượt bậc, mang lại hiệu quả lọc sạch tối ưu.</p>rn<h3>1. Bộ Lọc HEPA</h3>rn<p>Bộ lọc HEPA (High Efficiency Particulate Air) c&oacute; khả năng lọc 99.97% c&aacute;c hạt bụi c&oacute; k&iacute;ch thước từ 0.3 micron trở l&ecirc;n.</p>rn<h3>2. C&ocirc;ng Nghệ Ion &Acirc;m</h3>rn<p>Ion &acirc;m gi&uacute;p trung h&ograve;a c&aacute;c chất độc hại trong kh&ocirc;ng kh&iacute;, tạo ra m&ocirc;i trường trong l&agrave;nh v&agrave; an to&agrave;n cho sức khỏe.</p>rn<h3>3. Bộ Lọc Than Hoạt T&iacute;nh</h3>rn<p>Than hoạt t&iacute;nh c&oacute; khả năng hấp thụ m&ugrave;i h&ocirc;i v&agrave; c&aacute;c chất hữu cơ bay hơi (VOC) hiệu quả.</p>rn<h3>4. C&ocirc;ng Nghệ UV-C</h3>rn<p>Tia UV-C c&oacute; khả năng ti&ecirc;u diệt vi khuẩn, virus v&agrave; nấm mốc, đảm bảo kh&ocirc;ng kh&iacute; sạch khuẩn.</p>rn<h3>5. Bộ Lọc Nano Silver</h3>rn<p>Nano Silver c&oacute; t&iacute;nh kh&aacute;ng khuẩn tự nhi&ecirc;n, gi&uacute;p ngăn chặn sự ph&aacute;t triển của vi khuẩn tr&ecirc;n bề mặt lọc.</p>', 'news/7Qdq6vOO1tM0aklLSXWSqFc9E0MPVIu0iESdkQJx.jpg', 'công-nghệ', 'Admin', 0, 1, 67, '2025-08-28 22:31:56', '2025-08-29 00:10:02'),
(5, 'Thiết Kế Nhà Bếp Hiện Đại', 'thiet-ke-nha-bep-hien-dai', 'Những xu hướng thiết kế nhà bếp hiện đại kết hợp với máy hút mùi để tạo nên không gian bếp hoàn hảo và tiện nghi.', '<h2>Xu Hướng Thiết Kế Nh&agrave; Bếp 2025</h2>rn<p>Thiết kế nh&agrave; bếp hiện đại kh&ocirc;ng chỉ đẹp mắt m&agrave; c&ograve;n phải thực dụng v&agrave; tiện nghi cho cuộc sống h&agrave;ng ng&agrave;y.</p>rn<h3>1. Phong C&aacute;ch Tối Giản</h3>rn<p>Thiết kế tối giản với đường n&eacute;t sạch sẽ, m&agrave;u sắc trung t&iacute;nh v&agrave; kh&ocirc;ng gian mở tạo cảm gi&aacute;c thoải m&aacute;i.</p>rn<h3>2. T&iacute;ch Hợp C&ocirc;ng Nghệ Th&ocirc;ng Minh</h3>rn<p>M&aacute;y h&uacute;t m&ugrave;i th&ocirc;ng minh được t&iacute;ch hợp v&agrave;o thiết kế tổng thể, c&oacute; thể điều khiển qua app hoặc giọng n&oacute;i.</p>rn<h3>3. Vật Liệu Cao Cấp</h3>rn<p>Sử dụng đ&aacute; granite, th&eacute;p kh&ocirc;ng gỉ v&agrave; gỗ tự nhi&ecirc;n tạo n&ecirc;n vẻ sang trọng v&agrave; bền bỉ.</p>rn<h3>4. &Aacute;nh S&aacute;ng Tự Nhi&ecirc;n</h3>rn<p>Thiết kế cửa sổ lớn v&agrave; &aacute;nh s&aacute;ng LED gi&uacute;p kh&ocirc;ng gian bếp s&aacute;ng sủa v&agrave; tiết kiệm năng lượng.</p>rn<h3>5. Khu Vực Lưu Trữ Th&ocirc;ng Minh</h3>rn<p>Hệ thống tủ k&eacute;o hiện đại với ngăn k&eacute;o s&acirc;u v&agrave; kệ xoay gi&uacute;p tối ưu kh&ocirc;ng gian lưu trữ.</p>', 'news/aDYsfgfMIla9pyEqkJLuOx6exShqCaAHvhCj9PHe.jpg', 'thiết-kế', 'Admin', 0, 1, 45, '2025-08-28 22:31:56', '2025-08-29 00:10:10'),
(6, 'Máy Hút Mùi Tiết Kiệm Điện', 'may-hut-mui-tiet-kiem-dien', 'Cách chọn và sử dụng máy hút mùi để tiết kiệm điện năng hiệu quả mà vẫn đảm bảo hiệu suất hoạt động tối ưu.', '<h2>Tiết Kiệm Điện Với M&aacute;y H&uacute;t M&ugrave;i</h2>rn<p>Việc sử dụng m&aacute;y h&uacute;t m&ugrave;i hiệu quả kh&ocirc;ng chỉ gi&uacute;p tiết kiệm điện m&agrave; c&ograve;n bảo vệ m&ocirc;i trường.</p>rn<h3>1. Chọn C&ocirc;ng Suất Ph&ugrave; Hợp</h3>rn<p>Kh&ocirc;ng phải c&ocirc;ng suất cao lu&ocirc;n tốt. Chọn c&ocirc;ng suất ph&ugrave; hợp với k&iacute;ch thước bếp để tiết kiệm điện.</p>rn<h3>2. Sử Dụng C&ocirc;ng Nghệ Inverter</h3>rn<p>M&aacute;y h&uacute;t m&ugrave;i với c&ocirc;ng nghệ Inverter tiết kiệm điện l&ecirc;n đến 40% so với m&aacute;y th&ocirc;ng thường.</p>rn<h3>3. Điều Chỉnh Tốc Độ Hợp L&yacute;</h3>rn<p>Chỉ sử dụng tốc độ cao khi cần thiết, thường xuy&ecirc;n sử dụng tốc độ thấp v&agrave; trung b&igrave;nh.</p>rn<h3>4. Vệ Sinh Định Kỳ</h3>rn<p>Bộ lọc bẩn l&agrave;m tăng ti&ecirc;u thụ điện. Vệ sinh định kỳ gi&uacute;p m&aacute;y hoạt động hiệu quả hơn.</p>rn<h3>5. Tắt M&aacute;y Khi Kh&ocirc;ng Sử Dụng</h3>rn<p>Lu&ocirc;n tắt m&aacute;y h&uacute;t m&ugrave;i khi kh&ocirc;ng nấu ăn để tiết kiệm điện năng.</p>rn<h3>6. Sử Dụng Đ&egrave;n LED</h3>rn<p>Chọn m&aacute;y h&uacute;t m&ugrave;i c&oacute; đ&egrave;n LED thay v&igrave; đ&egrave;n halogen để tiết kiệm điện.</p>', 'news/jOnAp8iSw4XxwWCLxRkktwlevq9NJXbZ2ZMygGVX.png', 'tiết-kiệm', 'Admin', 0, 1, 78, '2025-08-28 22:31:56', '2025-08-29 00:10:21');
...
CREATE TABLE orders (
  ...
  payment_method varchar(30) check (payment_method in ('cod','bank_transfer','momo')) NOT NULL,
  payment_status varchar(30) check (payment_status in ('pending','paid','failed','refunded')) NOT NULL DEFAULT 'pending',
  ...
  status varchar(30) check (status in ('pending','waiting_payment','processing','shipped','delivered','cancelled')) DEFAULT 'pending',
...
--
-- SQLINES DEMO *** or table `order_history`
--
...
--
-- SQLINES DEMO *** or table `payment_methods`
--
...
CREATE TABLE products (
  ...
  features text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(features)),
...
--
-- SQLINES DEMO *** or table `product_details`
--

CREATE TABLE product_details (
  id bigint CHECK (id > 0) NOT NULL,
  product_id bigint CHECK (product_id > 0) NOT NULL,
  specs text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(specs)),
  created_at timestamp(0) NULL DEFAULT NULL,
  updated_at timestamp(0) NULL DEFAULT NULL
) ;
...
--
-- SQLINES DEMO *** or table `questions`
--
...
CREATE TABLE questions (
  ...
  content text NOT NULL,
  is_answered smallint NOT NULL DEFAULT 0,
  created_at timestamp(0) NULL DEFAULT NULL,
  updated_at timestamp(0) NULL DEFAULT NULL
) ;

--
-- SQLINES DEMO *** table `questions`
--
...
--
-- SQLINES DEMO *** or table `question_likes`
--
...
--
-- SQLINES DEMO *** table `question_likes`
--
...
CREATE TABLE reviews (
  ...
  user_id bigint CHECK (user_id > 0) NOT NULL,
  product_id bigint CHECK (product_id > 0) NOT NULL,
  order_item_id bigint CHECK (order_item_id > 0) DEFAULT NULL,
  rating smallint CHECK (rating > 0) NOT NULL,
  comment text DEFAULT NULL,
  admin_reply text DEFAULT NULL,
  admin_replied_at timestamp(0) NULL DEFAULT NULL,
  images text CHARACTER SET utf8mb4 DEFAULT NULL CHECK (json_valid(images)),
  created_at timestamp(0) NULL DEFAULT NULL,
  updated_at timestamp(0) NULL DEFAULT NULL
) ;
...
--
-- SQLINES DEMO *** or table `settings`
--
...
CREATE TABLE users (
  ...
  gender varchar(30) check (gender in ('male','female','other')) DEFAULT NULL,
  address text DEFAULT NULL,
  password varchar(255) NOT NULL,
  role varchar(30) check (role in ('admin','customer')) NOT NULL DEFAULT 'customer',
...
--
-- SQLINES DEMO ***  `inventory_transactions`
--
...
--
-- SQLINES DEMO *** r table `addresses`
--
ALTER TABLE addresses
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=6;

--
-- SQLINES DEMO *** r table `answers`
--
ALTER TABLE answers
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=12;

--
-- SQLINES DEMO *** r table `carts`
--
ALTER TABLE carts
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=15;

--
-- SQLINES DEMO *** r table `cart_items`
--
ALTER TABLE cart_items
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=15;
...
--
ALTER TABLE categories
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=7;

--
-- SQLINES DEMO *** r table `favorites`
--
ALTER TABLE favorites
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=39;

--
-- SQLINES DEMO *** r table `inventory_transactions`
--
ALTER TABLE inventory_transactions
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=58;

--
-- SQLINES DEMO *** r table `jobs`
--
ALTER TABLE jobs
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY;

--
-- SQLINES DEMO *** r table `messages`
--
ALTER TABLE messages
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=36;

--
-- SQLINES DEMO *** r table `migrations`
--
ALTER TABLE migrations
  MODIFY id int CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=54;
...
--
ALTER TABLE orders
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=53;

--
-- SQLINES DEMO *** r table `order_history`
--
ALTER TABLE order_history
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY;

--
-- SQLINES DEMO *** r table `order_items`
--
ALTER TABLE order_items
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=69;

--
-- SQLINES DEMO *** r table `payment_methods`
--
ALTER TABLE payment_methods
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY;
...
--
ALTER TABLE products
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=21;

--
-- SQLINES DEMO *** r table `product_details`
--
ALTER TABLE product_details
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY;

--
-- SQLINES DEMO *** r table `questions`
--
ALTER TABLE questions
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=12;

--
-- SQLINES DEMO *** r table `question_likes`
--
ALTER TABLE question_likes
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=4;

--
-- SQLINES DEMO *** r table `reviews`
--
ALTER TABLE reviews
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=10;

--
-- SQLINES DEMO *** r table `settings`
--
ALTER TABLE settings
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=2;

--
-- SQLINES DEMO *** r table `users`
--
ALTER TABLE users
  MODIFY id bigint CHECK (id > 0) NOT NULL GENERATED ALWAYS AS IDENTITY, AUTO_INCREMENT=16;
...
--
-- SQLINES DEMO *** able `addresses`
--
ALTER TABLE addresses
  ADD CONSTRAINT addresses_user_id_foreign FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE;

--
-- SQLINES DEMO *** able `answers`
--
ALTER TABLE answers
...
--
-- SQLINES DEMO *** able `carts`
--
ALTER TABLE carts
  ADD CONSTRAINT carts_user_id_foreign FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE;

--
-- SQLINES DEMO *** able `cart_items`
--
ALTER TABLE cart_items
...
--
-- SQLINES DEMO *** able `inventory_transactions`
--
ALTER TABLE inventory_transactions
...
--
-- SQLINES DEMO *** able `order_history`
--
ALTER TABLE order_history
