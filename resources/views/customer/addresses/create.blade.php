                ...
                <div class="card-body text-center py-4">
                    <div class="mb-3">
                        <div class="bg-primary rounded-circle d-inline-flex align-items-center justify-content-center" style="width: 80px; height: 80px;">
                            <i class="fas fa-plus text-white" style="font-size: 2rem;"></i>
                        </div>
                    </div>
                    <h2 class="fw-bold text-primary mb-2">Thêm địa chỉ mới</h2>
                    <p class="text-muted mb-0 fs-5">Thêm địa chỉ giao hàng để thuận tiện khi đặt hàng</p>
                </div>
            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select border-start-0 @error('ward_id') is-invalid @enderror" 
                                            id="ward_id" name="ward_id" required disabled>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control border-start-0 @error('street_address') is-invalid @enderror" 
                                              ...
                                              placeholder="Số nhà, tên đường, tên khu vực, tên chung cư..." required>{{ old('street_address') }}</textarea>
                                </div>
                        ...
                        <div class="col-md-6">
                            <ul class="list-unstyled mb-0">
                                <li class="mb-2">
                                    ...
                                    Chọn đầy đủ tỉnh thành, quận huyện, phường xã
                                </li>
                                <li class="mb-2">
                                    <i class="fas fa-check text-success me-2"></i>
                                    Nhập địa chỉ chi tiết rõ ràng
                                </li>
                                <li class="mb-2">
                                    <i class="fas fa-check text-success me-2"></i>
                                    Kiểm tra số điện thoại chính xác
                                </li>
                                <li class="mb-2">
                                    <i class="fas fa-check text-success me-2"></i>
                                    Đặt địa chỉ mặc định nếu cần
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-light rounded-3 p-3">
                                ...
                                <p class="text-muted mb-0 small">
                                    Địa chỉ càng chi tiết càng giúp việc giao hàng nhanh chóng và chính xác
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                if (data && data.length > 0) {
                    $.each(data, function(key, province) {
                        if (province.id && province.full_name) {
                            $('#province_id').append('<option value="' + province.id + '">' + province.full_name + '</option>');
                        }
                    });
                ...
                if (data && data.length > 0) {
                    ...
                    $.each(data, function(key, district) {
                        if (district.id && district.full_name) {
                            $('#district_id').append('<option value="' + district.id + '">' + district.full_name + '</option>');
                        }
                    });
                ...
                if (data && data.length > 0) {
                    ...
                    $.each(data, function(key, ward) {
                        if (ward.id && ward.full_name) {
                            $('#ward_id').append('<option value="' + ward.id + '">' + ward.full_name + '</option>');
                        }
                    });
